...
const entity = "mention_semestre_ecue_details";
...
export default {
  ...
  delete: (id) => api.remove(entity, id),
   ...
   getAllByMentionAnneeSemestre: (mentionId, anneeId, semestreId) => api.getAll(entity, { path: `mention/${mentionId}/annee/${anneeId}/semestre/${semestreId}`,}),
