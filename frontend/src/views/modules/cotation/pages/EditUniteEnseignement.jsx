...
export default function EditUniteEnseignement() {
  ...
  const ueToEdit = location.state?.ue;
  ...
  useEffect(() => {
    ...
    if (ueToEdit) {
      ...
      setForm({
        code: ueToEdit.code || "",
        intitule: ueToEdit.intitule || "",
        credit: ueToEdit.credit || "",

        nombreHeureCmi:
          ueToEdit.nombre_heure_cmi || "",

        nombreHeureTd:
          ueToEdit.nombre_heure_td || "",

        nombreHeureTp:
          ueToEdit.nombre_heure_tp || "",
      });
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (ueToEdit) {
        ...
        await uniteEnseignementService.update(
          ueToEdit.id,
          data
        );
        ...
        await uniteEnseignementService.add(
          data
        );
      }
      ...
      showToast(
        ueToEdit
          ...
          : "Unité d’enseignement enregistrée avec succès !"
      );

      setTimeout(() => {

        navigate(
          "/inscription/unite-enseignement"
        );
